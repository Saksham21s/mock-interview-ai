...
//   // Local state
//   const memoizedQuestionsData = useMemo(() => questionBank, [questionBank]);
...
//   //disable right click in interview page //
//   useEffect(() => {
//     if (window.location.pathname === "/interview-session") {
...
//   // Save to both sessionStorage keys for compatibility
//   sessionStorage.setItem('responses', JSON.stringify(updatedResponses));
  
//   // Also update the full interview state
//   const stateToSave = {
